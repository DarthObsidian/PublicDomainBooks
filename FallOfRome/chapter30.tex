...
\begin{quote}
\textit{Alii per toga ferocis Danubii solidata ruunt; expertaque remis
...
\begin{quote}
\textit{Nec fera Cecropias traxissent vincula matres.}
\end{quote}
...
\pagenote[9]{—
\begin{quote}
\textit{Vallata mari Scironia rupes, Et duo continuo connectens aequora
...
\begin{quote}
\textit{—-Et Alpheus Geticis angustus acervis Tardior ad Siculos etiamnum
pergit amores.}
\end{quote}
...
\begin{quote}
\textit{Ditatur: qui servat, eget: vastator Achivae Gentis, et Epirum
...
\begin{quote}
\textit{Discors odiisque anceps civilibus orbis, Non sua vis tutata diu,
...
\pagenote[31]{
\begin{quote}
\textit{Ingentem meminit parvo qui germine quercum Aequaevumque videt
consenuisse nemus.}

\textit{A neighboring wood born with himself he sees, And loves his old
contemporary trees.}
\end{quote}
...
\pagenote[36]{
\begin{quote}
\textit{Venit et extremis legio praetenta Britannis, Quae Scoto dat frena
...
\pagenote[50]{
\begin{quote}
\textit{Et gravant en airain ses freles avantages De mes etats conquis
...
\pagenote[70]{
\begin{quote}
\textit{Cujus agendi Spectator vel causa fui, —-(Claudian, vi. Cons. Hon.
439,)}
\end{quote}
...
\pagenote[78]{
\begin{quote}
\textit{Franguntur montes, planumque per ardua Caesar Ducit opus: pandit
...
\begin{quote}
\textit{Provincia missos Expellet citius fasces, quam Francia reges Quos
dederis.}
\end{quote}
...
\pagenote[100]{
\begin{quote}
\textit{Comitatur euntem Pallor, et atra fames; et saucia lividus ora
...
\begin{quote}
\textit{Quo magis est facinus diri Stilichonis iniquum Proditor arcani
...
\begin{quote}
\textit{Mallius indulget somno noctesque diesque: Insomnis Pharius sacra,
...
\begin{quote}
\textit{... Non littora nostro Sufficerent angusta Deo.}
\end{quote}
...
\begin{quote}
\textit{... Quae tunc documenta futuri? Quae voces avium? quanti per inane
