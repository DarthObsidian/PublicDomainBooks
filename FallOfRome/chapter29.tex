...
\begin{quote}
\textit{Ibat grandaevus nato moriente superstes Post trabeas exsul. —-In
Rufin. i. 248.}
\end{quote}
...
\begin{quote}
\textit{—-Exscindere cives Funditus; et nomen gentis delere laborat.}
\end{quote}
...
\pagenote[11]{
\begin{quote}
\textit{—fluctibus auri Expleri sitis ista nequit— ***** Congestae
...
\pagenote[12]{
\begin{quote}
\textit{—Caetera segnis; Ad facinus velox; penitus regione remotas Impiger
ire vias.}
\end{quote}
...
\begin{quote}
\textit{Cedere grandaevos equitum peditumque magistros}
\end{quote}
...
\begin{quote}
\textit{—-Plaudentem cerne senatum, Et Byzantinos proceres Graiosque
...
\pagenote[38]{
\begin{quote}
\textit{Instat terribilis vivis, morientibus haeres, Virginibus raptor,
...
\begin{quote}
\textit{—-Nunquam libertas gratior exstat, Quam sub rege pio.}
\end{quote}
...
\begin{quote}
\textit{Calet obvius ire Jam princeps, tardumque cupit discedere solem.
...
\begin{quote}
\textit{Dices, O quoties,hoc mihi dulcius Quam flavos decics vincere
