...
Dorante or Valère reply to Alceste\footnote[21]{In Molière’s comedy, \textit{Le Misanthrope.}} at the Théâtre Français.
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50025m.jpg}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50027m.jpg}
\end{figure}
...
indifferent to the restraints of what Boileau calls the \textit{style
énergique}) commented on the feverish agitation of Andrea, on M.
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50031m.jpg}
\end{figure}
...
apartments, \textit{quærens quem devoret}. There was, indeed, reason to
