...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50201m.jpg}
\end{figure}
...
“Maximilian goes with \textit{me},” said the count, in his kindest and most
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50203m.jpg}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50205m.jpg}
\end{figure}
...
Saint-Nicolas, the City Hall designed by Puget,\footnote[28]{Gaspard Puget,
the sculptor-architect, was born at Marseilles in 1615.} the port with its
...
the spot where my father stopped, when the \textit{Pharaon} entered the port;
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50209m.jpg}
\end{figure}
...
an arbor of Virginia jessamine,\footnote[29]{The Carolina—not Virginia—jessamine,
\textit{gelsemium sempervirens} (properly speaking not a jessamine at all)
has yellow blossoms. The reference is no doubt to the \textit{Wistaria frutescens}.—Ed.}
with its thick foliage and beautiful
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50211m.jpg}
\end{figure}
...
“Hate you, blame you—\textit{you}, Edmond! Hate, reproach, the man that has
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50213m.jpg}
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{50215m.jpg}
\end{figure}
